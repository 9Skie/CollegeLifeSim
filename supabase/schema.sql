...
INSERT INTO wildcard_defs (id, tier, title, emoji, description, effect_summary, duration, target_stats, immediate, future, metadata) VALUES
  ('WC-001', 'really_bad', 'Academic Probation', '📉', 'You check your portal way too late at night and instantly wish you had not. One awful grade is enough to ruin your entire mood and your academic confidence.', 'Academics -2.0', 'immediate', '["academics"]'::jsonb, '{"academics":-2}'::jsonb, NULL, '{}'::jsonb),
  ('WC-002', 'really_bad', 'Food Poisoning', '🤢', 'Something from the dining hall fights back. You spend the rest of the day miserable, weak, and deeply suspicious of institutional cooking.', 'Wellbeing -2.0', 'immediate', '["wellbeing"]'::jsonb, '{"wellbeing":-2}'::jsonb, NULL, '{}'::jsonb),
  ('WC-003', 'really_bad', 'Wallet Gone', '💸', 'Somewhere between class, the bus stop, and your dorm, your wallet ceases to exist. Replacing everything feels expensive and humiliating.', 'Money -2.0', 'immediate', '["money"]'::jsonb, '{"money":-2}'::jsonb, NULL, '{}'::jsonb),
  ('WC-004', 'really_bad', 'Public Humiliation', '😬', 'You say the wrong thing in front of the wrong crowd and it lands like a brick. People definitely remember and unfortunately so do you.', 'Social -2.0', 'immediate', '["social"]'::jsonb, '{"social":-2}'::jsonb, NULL, '{}'::jsonb),
  ('WC-005', 'really_bad', 'Group Project Disaster', '🧨', 'Your teammates vanish, the document is empty, and the deadline is now somehow your personal problem. The stress wrecks both your output and your sanity.', 'Academics -1.0, Wellbeing -1.0', 'immediate', '["academics","wellbeing"]'::jsonb, '{"academics":-1,"wellbeing":-1}'::jsonb, NULL, '{}'::jsonb),
  ('WC-006', 'really_bad', 'ER Visit', '🚑', 'A stupid accident turns into a long miserable wait and a bill you absolutely did not budget for. The whole day is gone and you feel awful.', 'Money -1.0, Wellbeing -1.5', 'immediate', '["money","wellbeing"]'::jsonb, '{"money":-1,"wellbeing":-1.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-007', 'really_bad', 'Spiral Night', '🌪️', 'You mean to scroll for ten minutes and somehow lose the entire night to anxiety, bad comparisons, and existential nonsense. Morning arrives without mercy.', 'Social -0.5, Wellbeing -1.5', 'immediate', '["social","wellbeing"]'::jsonb, '{"social":-0.5,"wellbeing":-1.5}'::jsonb, NULL, '{}'::jsonb),

  ('WC-008', 'bad', 'Missed Alarm', '⏰', 'You wake up in full panic mode, already late, already sweaty, and already behind. The whole day feels cursed from the first second.', 'Academics -1.0', 'immediate', '["academics"]'::jsonb, '{"academics":-1}'::jsonb, NULL, '{}'::jsonb),
  ('WC-009', 'bad', 'Awkward Hangout', '😶', 'You try to be normal, charming, or even just vaguely fun, and somehow the whole interaction goes stiff and weird. You replay it later against your will.', 'Social -1.0', 'immediate', '["social"]'::jsonb, '{"social":-1}'::jsonb, NULL, '{}'::jsonb),
  ('WC-010', 'bad', 'Impulse Purchase', '🛍️', 'You convince yourself this is self-care and then immediately feel stupid the second the payment goes through. Cute item, terrible decision.', 'Money -1.0', 'immediate', '["money"]'::jsonb, '{"money":-1}'::jsonb, NULL, '{}'::jsonb),
  ('WC-011', 'bad', 'Minor Cold', '🤧', 'Not sick enough to stay in bed, but sick enough to hate moving, thinking, and existing. The kind of illness that makes everything mildly worse.', 'Wellbeing -1.0', 'immediate', '["wellbeing"]'::jsonb, '{"wellbeing":-1}'::jsonb, NULL, '{}'::jsonb),
  ('WC-012', 'bad', 'Parking Ticket', '🚓', 'Campus enforcement remains the most efficient institution in your life. They spot you instantly and improve your day in the worst possible way.', 'Money -0.75, Wellbeing -0.25', 'immediate', '["money","wellbeing"]'::jsonb, '{"money":-0.75,"wellbeing":-0.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-013', 'bad', 'Bad Study Session', '📚', 'You spend an hour reading the same paragraph and somehow come away understanding less than when you started. Time wasted, confidence damaged.', 'Academics -0.75', 'immediate', '["academics"]'::jsonb, '{"academics":-0.75}'::jsonb, NULL, '{}'::jsonb),
  ('WC-014', 'bad', 'Overheard Rumor', '👂', 'A stupid rumor about you starts floating around campus and there is no graceful way to unhear it. Even worse, other people have heard it too.', 'Social -0.75, Wellbeing -0.25', 'immediate', '["social","wellbeing"]'::jsonb, '{"social":-0.75,"wellbeing":-0.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-015', 'bad', 'Shattered Phone', '📱', 'One bad drop and your phone screen becomes a cracked spiderweb. You can still use it, which almost makes it more annoying.', 'Money -0.75', 'immediate', '["money"]'::jsonb, '{"money":-0.75}'::jsonb, NULL, '{}'::jsonb),
  ('WC-016', 'bad', 'Missed Meal', '🍽️', 'You get too busy, too lazy, or too overwhelmed to eat properly, and your body makes sure you pay for it later.', 'Wellbeing -0.75', 'immediate', '["wellbeing"]'::jsonb, '{"wellbeing":-0.75}'::jsonb, NULL, '{}'::jsonb),
  ('WC-017', 'bad', 'Laundry Disaster', '🧺', 'Everything is either shrunken, weirdly stained, or somehow all pink now. Doing chores should not feel like losing a boss fight.', 'Money -0.5, Wellbeing -0.5', 'immediate', '["money","wellbeing"]'::jsonb, '{"money":-0.5,"wellbeing":-0.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-018', 'bad', 'Peer Comparison', '🪞', 'Everyone around you suddenly looks more successful, more stable, and more put together than you. Rationally, that means nothing. Emotionally, it means a lot.', 'Wellbeing -0.5, Social -0.5', 'immediate', '["wellbeing","social"]'::jsonb, '{"wellbeing":-0.5,"social":-0.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-019', 'bad', 'Broken Printer', '🖨️', 'The assignment is finished, but the printer you need has chosen violence. A simple task becomes an expensive personal feud.', 'Academics -0.5, Money -0.25', 'immediate', '["academics","money"]'::jsonb, '{"academics":-0.5,"money":-0.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-020', 'bad', 'Wrong Classroom', '🚪', 'You sit in the wrong class just long enough to realize you have deeply misread your day. The rest of the schedule never fully recovers.', 'Academics -0.5', 'immediate', '["academics"]'::jsonb, '{"academics":-0.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-021', 'bad', 'Terrible Coffee', '☕', 'You pay too much for a drink that tastes burnt and still leaves you exhausted. It feels almost personal.', 'Money -0.25, Wellbeing -0.5', 'immediate', '["money","wellbeing"]'::jsonb, '{"money":-0.25,"wellbeing":-0.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-022', 'bad', 'Rain-Soaked Walk', '🌧️', 'You get drenched crossing campus and spend the rest of the day cold, damp, and quietly furious at the weather and your choices.', 'Wellbeing -0.5', 'immediate', '["wellbeing"]'::jsonb, '{"wellbeing":-0.5}'::jsonb, NULL, '{}'::jsonb),

  ('WC-023', 'normal', 'Found Twenty', '💵', 'A crumpled bill shows up in a coat pocket or notebook at exactly the right time. It is not a lot, but it feels like divine intervention.', 'Money +1.0', 'immediate', '["money"]'::jsonb, '{"money":1}'::jsonb, NULL, '{}'::jsonb),
  ('WC-024', 'normal', 'Unexpected Nap', '😌', 'You lie down for what should be ten minutes and wake up feeling weirdly human again. It solves more than it should.', 'Wellbeing +1.0', 'immediate', '["wellbeing"]'::jsonb, '{"wellbeing":1}'::jsonb, NULL, '{}'::jsonb),
  ('WC-025', 'normal', 'Clean Notes Swap', '📝', 'Someone hands you notes that are actually understandable. The material suddenly stops feeling like it was written in code.', 'Academics +1.0', 'immediate', '["academics"]'::jsonb, '{"academics":1}'::jsonb, NULL, '{}'::jsonb),
  ('WC-026', 'normal', 'Friendly Hallway Chat', '🙂', 'A random conversation hits at exactly the right moment and reminds you campus is not entirely full of strangers and deadlines.', 'Social +1.0', 'immediate', '["social"]'::jsonb, '{"social":1}'::jsonb, NULL, '{}'::jsonb),
  ('WC-027', 'normal', 'Free Pizza Slice', '🍕', 'You wander into a club event by accident and leave fed. That alone makes the detour worth it.', 'Money +0.5, Wellbeing +0.5', 'immediate', '["money","wellbeing"]'::jsonb, '{"money":0.5,"wellbeing":0.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-028', 'normal', 'Good Playlist', '🎧', 'The right song at the right time makes your walk across campus feel like a movie instead of a commute.', 'Wellbeing +0.75, Social +0.25', 'immediate', '["wellbeing","social"]'::jsonb, '{"wellbeing":0.75,"social":0.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-029', 'normal', 'Study Groove', '🧠', 'For once, your brain actually locks in. The words stick, the work moves, and you stop feeling cursed for a few hours.', 'Academics +0.75, Wellbeing +0.25', 'immediate', '["academics","wellbeing"]'::jsonb, '{"academics":0.75,"wellbeing":0.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-030', 'normal', 'Tipsy Tip Jar', '☕', 'The shift is boring, but customers are weirdly generous and no one makes your life harder than necessary. Rare and beautiful.', 'Money +0.75, Social +0.25', 'immediate', '["money","social"]'::jsonb, '{"money":0.75,"social":0.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-031', 'normal', 'Sunny Bench Break', '🌤️', 'You accidentally take ten peaceful minutes in the sun and come back to the day slightly less like a live grenade.', 'Wellbeing +0.75', 'immediate', '["wellbeing"]'::jsonb, '{"wellbeing":0.75}'::jsonb, NULL, '{}'::jsonb),
  ('WC-032', 'normal', 'Good Hair Day', '💁', 'Your reflection cooperates for once and your confidence quietly improves all day because of it.', 'Social +0.75', 'immediate', '["social"]'::jsonb, '{"social":0.75}'::jsonb, NULL, '{}'::jsonb),
  ('WC-033', 'normal', 'Club Flyer Curiosity', '📣', 'You follow a random flyer or friend into the right room at the right time and come out with something actually useful.', 'Social +0.5, Academics +0.5', 'immediate', '["social","academics"]'::jsonb, '{"social":0.5,"academics":0.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-034', 'normal', 'Meal Swipe Gift', '🎟️', 'Someone with an extra swipe saves you from spending money and from pretending ramen counts as balance.', 'Money +0.5, Wellbeing +0.5', 'immediate', '["money","wellbeing"]'::jsonb, '{"money":0.5,"wellbeing":0.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-035', 'normal', 'Tutor Tip', '💡', 'One offhand explanation from the right person makes a whole topic click in a way your textbook never managed.', 'Academics +0.75', 'immediate', '["academics"]'::jsonb, '{"academics":0.75}'::jsonb, NULL, '{}'::jsonb),
  ('WC-036', 'normal', 'Free Bus Ride', '🚌', 'You save both time and energy by catching a lucky ride when your feet were already done with the day.', 'Money +0.25, Wellbeing +0.5', 'immediate', '["money","wellbeing"]'::jsonb, '{"money":0.25,"wellbeing":0.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-037', 'normal', 'Late Library Hours', '🌃', 'The library stays open just long enough for you to actually get something done instead of giving up and going home.', 'Academics +0.5, Wellbeing +0.25', 'immediate', '["academics","wellbeing"]'::jsonb, '{"academics":0.5,"wellbeing":0.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-038', 'normal', 'Compliment from a Stranger', '🌟', 'Someone says something kind at exactly the moment you needed a reason to be less brutal to yourself.', 'Social +0.5, Wellbeing +0.25', 'immediate', '["social","wellbeing"]'::jsonb, '{"social":0.5,"wellbeing":0.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-039', 'normal', 'Campus Freebie Bag', '🎁', 'Most of it is junk, but enough of it is useful that the whole experience feels like a tiny lottery win.', 'Money +0.75', 'immediate', '["money"]'::jsonb, '{"money":0.75}'::jsonb, NULL, '{}'::jsonb),
  ('WC-040', 'normal', 'Rain Delay Reset', '☔', 'Plans fall apart, but the forced pause gives you a little more room to breathe than you had before.', 'Wellbeing +0.75', 'immediate', '["wellbeing"]'::jsonb, '{"wellbeing":0.75}'::jsonb, NULL, '{}'::jsonb),
  ('WC-041', 'normal', 'Lucky Seat in Class', '🪑', 'You sit next to the one person who actually understood the lecture and they explain it in plain English after class.', 'Academics +0.5, Social +0.25', 'immediate', '["academics","social"]'::jsonb, '{"academics":0.5,"social":0.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-042', 'normal', 'Decent Shift', '🍽️', 'Nothing catches fire, nobody yells at you, and the money arrives exactly as promised. That alone feels luxurious.', 'Money +1.0', 'immediate', '["money"]'::jsonb, '{"money":1}'::jsonb, NULL, '{}'::jsonb),
  ('WC-043', 'normal', 'Stretch Break', '🧘', 'A simple break for your body resets more tension than you realized you were carrying around all day.', 'Wellbeing +0.75', 'immediate', '["wellbeing"]'::jsonb, '{"wellbeing":0.75}'::jsonb, NULL, '{}'::jsonb),
  ('WC-044', 'normal', 'Small Scholarship Email', '📩', 'It is not life-changing money, but it lands in your inbox at exactly the right moment to matter.', 'Money +0.75', 'immediate', '["money"]'::jsonb, '{"money":0.75}'::jsonb, NULL, '{}'::jsonb),
  ('WC-045', 'normal', 'Lucky Guess', '❓', 'You gamble on a question, a call, or a small decision and somehow come out looking smarter than you felt.', 'Academics +0.75', 'immediate', '["academics"]'::jsonb, '{"academics":0.75}'::jsonb, NULL, '{}'::jsonb),
  ('WC-046', 'normal', 'Vending Jackpot', '🥤', 'The machine double-drops your snack and for one beautiful second you believe the universe is not entirely against you.', 'Money +0.25, Wellbeing +0.5', 'immediate', '["money","wellbeing"]'::jsonb, '{"money":0.25,"wellbeing":0.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-047', 'normal', 'Syllabus Surprise', '📋', 'Your professor drops the lowest quiz score and the whole class experiences one shared moment of hope.', 'Academics +0.75, Wellbeing +0.25', 'immediate', '["academics","wellbeing"]'::jsonb, '{"academics":0.75,"wellbeing":0.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-048', 'normal', 'Free Laundry', '🧺', 'Someone left quarters in the machine and you get to wash your clothes without paying. Weirdly thrilling.', 'Money +0.5, Wellbeing +0.5', 'immediate', '["money","wellbeing"]'::jsonb, '{"money":0.5,"wellbeing":0.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-049', 'normal', 'Pet a Campus Dog', '🐕', 'A stranger''s dog lets you pet it for five full minutes and your entire nervous system calms down.', 'Wellbeing +1.0', 'immediate', '["wellbeing"]'::jsonb, '{"wellbeing":1}'::jsonb, NULL, '{}'::jsonb),
  ('WC-050', 'normal', 'Extended Deadline', '⏳', 'The due date moves back by a weekend and suddenly life feels survivable again.', 'Academics +0.75', 'immediate', '["academics"]'::jsonb, '{"academics":0.75}'::jsonb, NULL, '{}'::jsonb),
  ('WC-051', 'normal', 'Empty Gym', '🏋️', 'You walk into the rec center and every machine you want is open. No waiting, no crowd, no stress.', 'Wellbeing +0.5, Social +0.25', 'immediate', '["wellbeing","social"]'::jsonb, '{"wellbeing":0.5,"social":0.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-052', 'normal', 'Shared Ride', '🚗', 'A friend splits gas and somehow also makes the trip enjoyable enough that you forget how stressed you were.', 'Money +0.75, Social +0.25', 'immediate', '["money","social"]'::jsonb, '{"money":0.75,"social":0.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-053', 'normal', 'Power Nap', '😴', 'Exactly twenty minutes of unconsciousness resets your personality in the best possible way.', 'Wellbeing +0.75', 'immediate', '["wellbeing"]'::jsonb, '{"wellbeing":0.75}'::jsonb, NULL, '{}'::jsonb),
  ('WC-054', 'normal', 'Free Sample Day', '🛍️', 'You drift through events collecting snacks, tote bags, and random little free things until the whole day feels profitable.', 'Money +1.0', 'immediate', '["money"]'::jsonb, '{"money":1}'::jsonb, NULL, '{}'::jsonb),
  ('WC-055', 'normal', 'Ghosted Class', '👻', 'The TA never shows, everyone leaves, and you gain an hour of your life back with zero guilt.', 'Wellbeing +0.5, Academics +0.25', 'immediate', '["wellbeing","academics"]'::jsonb, '{"wellbeing":0.5,"academics":0.25}'::jsonb, NULL, '{}'::jsonb),

  ('WC-056', 'good', 'Professor Mercy', '🎓', 'The professor gives the class a hint, extension, or break they absolutely did not have to give you.', 'Academics +1.5', 'immediate', '["academics"]'::jsonb, '{"academics":1.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-057', 'good', 'Perfect Sleep', '😴', 'You wake up feeling suspiciously rested, like your body finally remembered it is supposed to help you.', 'Wellbeing +1.5', 'immediate', '["wellbeing"]'::jsonb, '{"wellbeing":1.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-058', 'good', 'Cash Gig', '💼', 'A random one-day job appears and somehow pays better than any of your normal opportunities.', 'Money +1.5', 'immediate', '["money"]'::jsonb, '{"money":1.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-059', 'good', 'Magnetic Energy', '✨', 'People are weirdly drawn to you today, and every conversation goes a little smoother than expected.', 'Social +1.5', 'immediate', '["social"]'::jsonb, '{"social":1.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-060', 'good', 'Locked-In Study Day', '📚', 'The distractions vanish and your brain finally behaves. You get through a shocking amount of work without suffering.', 'Academics +1.25, Wellbeing +0.25', 'immediate', '["academics","wellbeing"]'::jsonb, '{"academics":1.25,"wellbeing":0.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-061', 'good', 'Healing Weekend', '🛀', 'You somehow spend a whole stretch of time making healthy choices and not regretting a single one of them.', 'Wellbeing +1.25, Social +0.25', 'immediate', '["wellbeing","social"]'::jsonb, '{"wellbeing":1.25,"social":0.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-062', 'good', 'Great Tips Night', '🍻', 'Customers are nice, management is absent, and the money stacks faster than your stress does.', 'Money +1.25, Social +0.25', 'immediate', '["money","social"]'::jsonb, '{"money":1.25,"social":0.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-063', 'good', 'Campus Celebrity Moment', '📸', 'For one evening, people know your name for a good reason and it feels incredible.', 'Social +1.25, Wellbeing +0.25', 'immediate', '["social","wellbeing"]'::jsonb, '{"social":1.25,"wellbeing":0.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-064', 'good', 'Advisor Hookup', '🧠', 'You get pointed toward exactly the right office, person, or resource at exactly the right time.', 'Academics +1.0, Money +0.5', 'immediate', '["academics","money"]'::jsonb, '{"academics":1.0,"money":0.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-065', 'good', 'Recharge Day', '🌿', 'You do less, breathe more, and somehow come out ahead because your brain and body stop fighting you for once.', 'Wellbeing +1.0, Academics +0.5', 'immediate', '["wellbeing","academics"]'::jsonb, '{"wellbeing":1.0,"academics":0.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-066', 'good', 'Good Crowd', '🫶', 'You land in a room where everyone is easy to talk to and no one drains your social battery.', 'Social +1.0, Money +0.5', 'immediate', '["social","money"]'::jsonb, '{"social":1.0,"money":0.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-067', 'good', 'Paid Opportunity', '📑', 'Somebody notices competence and turns it into actual money. Rare, beautiful, and highly motivating.', 'Money +1.0, Academics +0.5', 'immediate', '["money","academics"]'::jsonb, '{"money":1.0,"academics":0.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-068', 'good', 'Lucky Break', '🍀', 'A few small things go right in a row and your entire day becomes easier to live inside.', 'Academics +0.75, Wellbeing +0.75', 'immediate', '["academics","wellbeing"]'::jsonb, '{"academics":0.75,"wellbeing":0.75}'::jsonb, NULL, '{}'::jsonb),
  ('WC-069', 'good', 'Confidence Surge', '🔥', 'You stop second-guessing every move and suddenly life feels a lot more playable.', 'Social +0.75, Wellbeing +0.75', 'immediate', '["social","wellbeing"]'::jsonb, '{"social":0.75,"wellbeing":0.75}'::jsonb, NULL, '{}'::jsonb),
  ('WC-070', 'good', 'Free Groceries', '🛒', 'Someone moving out hands you a ridiculous amount of usable food. You feel briefly rich and strangely cared for.', 'Money +0.75, Wellbeing +0.75', 'immediate', '["money","wellbeing"]'::jsonb, '{"money":0.75,"wellbeing":0.75}'::jsonb, NULL, '{}'::jsonb),
  ('WC-071', 'good', 'Research Assistant Lead', '🔬', 'A professor, TA, or grad student points you toward a real opportunity that makes you feel terrifyingly competent.', 'Academics +1.25', 'immediate', '["academics"]'::jsonb, '{"academics":1.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-072', 'good', 'Great Gym Session', '🏋️', 'Your body cooperates, your lungs behave, and you leave feeling annoyingly healthy and smug.', 'Wellbeing +1.25', 'immediate', '["wellbeing"]'::jsonb, '{"wellbeing":1.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-073', 'good', 'Unexpected Venmo', '📲', 'Somebody finally pays you back for something ancient and you stop believing in karma out of sheer surprise.', 'Money +1.25', 'immediate', '["money"]'::jsonb, '{"money":1.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-074', 'good', 'Party Win', '🪩', 'You go out, have fun, meet people, and somehow avoid doing anything embarrassing. Historic success.', 'Social +1.25', 'immediate', '["social"]'::jsonb, '{"social":1.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-075', 'good', 'Dean''s List Letter', '📜', 'A letter arrives telling you your grades put you on the honors list. It glows on your desk like emotional sunscreen.', 'Academics +1.25, Wellbeing +0.25', 'immediate', '["academics","wellbeing"]'::jsonb, '{"academics":1.25,"wellbeing":0.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-076', 'good', 'Weekend Trip', '🏕️', 'You escape campus with the exact right people and return genuinely refreshed instead of just less exhausted.', 'Wellbeing +1.25, Social +0.25', 'immediate', '["wellbeing","social"]'::jsonb, '{"wellbeing":1.25,"social":0.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-077', 'good', 'Research Grant', '🔬', 'A small grant lands with your name on it. Not life-changing, but enough to make your future feel a little less fake.', 'Money +1.25, Academics +0.25', 'immediate', '["money","academics"]'::jsonb, '{"money":1.25,"academics":0.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-078', 'good', 'Perfect Test Score', '💯', 'You get a score back so good you check it three times before trusting your own eyes.', 'Academics +1.5', 'immediate', '["academics"]'::jsonb, '{"academics":1.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-079', 'good', 'Roommate Bought Groceries', '🛒', 'You open the fridge and discover your roommate stocked it like they care about your survival. Weirdly moving.', 'Money +1.0, Wellbeing +0.5', 'immediate', '["money","wellbeing"]'::jsonb, '{"money":1.0,"wellbeing":0.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-080', 'good', 'Alumni Connection', '🤝', 'A random intro turns into a real professional contact who actually follows through. You feel briefly chosen.', 'Social +1.0, Money +0.5', 'immediate', '["social","money"]'::jsonb, '{"social":1.0,"money":0.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-081', 'good', 'Campus Job Promotion', '📈', 'Your boss offers you a better role with better pay and only slightly more responsibility. You say yes immediately.', 'Money +1.5', 'immediate', '["money"]'::jsonb, '{"money":1.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-082', 'good', 'Concert Tickets', '🎫', 'A friend hands you tickets to something you had no business attending and the whole night feels stolen from a better timeline.', 'Social +1.25, Wellbeing +0.25', 'immediate', '["social","wellbeing"]'::jsonb, '{"social":1.25,"wellbeing":0.25}'::jsonb, NULL, '{}'::jsonb),
  ('WC-083', 'good', 'Wellness Retreat', '🧖', 'Campus runs a free spa-day event and you emerge feeling suspiciously stable and at peace with your own existence.', 'Wellbeing +1.5', 'immediate', '["wellbeing"]'::jsonb, '{"wellbeing":1.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-084', 'good', 'Study Abroad Info', '✈️', 'An info session about a semester abroad makes your future feel bigger and more exciting than it did this morning.', 'Social +1.0, Academics +0.5', 'immediate', '["social","academics"]'::jsonb, '{"social":1.0,"academics":0.5}'::jsonb, NULL, '{}'::jsonb),
  ('WC-085', 'good', 'Campus Award', '🏅', 'You win a minor campus award that comes with a certificate, a handshake, and actual money. Not bad for showing up.', 'Academics +1.0, Money +0.5', 'immediate', '["academics","money"]'::jsonb, '{"academics":1.0,"money":0.5}'::jsonb, NULL, '{}'::jsonb),
